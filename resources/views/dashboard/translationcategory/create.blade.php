...
@section('body')
    <form class="needs-validation" novalidate method="post" enctype="multipart/form-data"
          action="{{isset($translationcategory)?route('translation-category.update',$translationcategory->id):route('translation-category.store')}}">
        @csrf
        @if( isset($translationcategory))
            @method('put')
        @endif
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title"> Translation CAtegory</h2>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row g-1">
                                <div class="col-md-4 col-12 mb-3 position-relative">
                                    ...
                                    <input type="text" class="form-control" id="validationTooltip01" placeholder=" name"
                                           name="name"
                                           value="{{isset($translationcategory)?$translationcategory->name:null}}"
                                           required/>
