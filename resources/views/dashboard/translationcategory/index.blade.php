        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Cateogry Translation Table </h4>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        <tr>
                            @foreach($translationcategory as $item )
                                <td> <a href="{{route('translation-category.show',$item->id)}}">  {{$item->name}}</a></td>
