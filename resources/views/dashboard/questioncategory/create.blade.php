...
@section('body')
    <form class="needs-validation" novalidate method="post" enctype="multipart/form-data"
          action="{{ isset($questioncategory)?
                            route('question-category.update',$questioncategory->id):route('question-category.store')}}">
        @csrf
                            ...
                            <div class="row g-1">
                                <div class="col-md-4 col-12 mb-3 position-relative">
                                    ...
                                    <input type="text" class="form-control" id="validationTooltip01" placeholder=" name"
                                           name="name" value="{{isset($questioncategory)?$questioncategory->name:null}}"
                                           required/>
